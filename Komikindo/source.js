...
const KomikindoMain_1 = require("../Komikindo/KomikindoMain");
const Komikindo_DOMAIN = 'https://komikindo.co';
exports.KomikindoInfo = {
    version: KomikindoMain_1.getExportVersion('0.0.0'),
    name: 'Komikindo',
    description: 'Extension that pulls manga from Komikindo',
    author: 'heznetcom',
...
class Komikindo extends KomikindoMain_1.KomikindoMain {
    constructor() {
...
},{"../Komikindo/KomikindoMain":58,"paperback-extensions-common":14}],58:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.KomikindoMain = exports.getExportVersion = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const KomikindoMainParser_1 = require("../Komikindo/KomikindoMainParser");
...
class KomikindoMain extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        /**
        ...
        */
        ...
        this.homescreen_NewManga_enabled = true;
        this.homescreen_NewManga_selector = 'h3:contains(MANGA TERBARU)';
        this.homescreen_TopAllTime_enabled = true;
        ...
        this.parser = new KomikindoMainParser_1.KomikindoMainParser();
    }
...
exports.KomikindoMain = KomikindoMain;

},{"../Komikindo/KomikindoMainParser":59,"paperback-extensions-common":14}],59:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KomikindoMainParser = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const LanguageUtils_1 = require("../LanguageUtils");
const entities = require("entities");
class KomikindoMainParser {
    constructor() {
...
exports.KomikindoMainParser = KomikindoMainParser;
