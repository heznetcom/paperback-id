...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KomikAV = exports.KomikAVInfo = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const MangaStream_1 = require("../MangaStream");
const KOMIKAV_DOMAIN = 'https://komikav.com';
exports.KomikAVInfo = {
    version: MangaStream_1.getExportVersion('0.0.0'),
    name: 'KomikAV',
    description: 'Extension that pulls manga from KomikAV',
    author: 'Len',
    authorWebsite: 'http://192.168.50.227:8080',
    icon: 'icon.png',
    contentRating: paperback_extensions_common_1.ContentRating.MATURE,
    websiteBaseURL: KOMIKAV_DOMAIN,
    sourceTags: [
        {
            text: 'Notifications',
...
class KomikAV extends MangaStream_1.MangaStream {
    constructor() {
        //FOR ALL THE SELECTIONS, PLEASE CHECK THE MangaSteam.ts FILE!!!
        super(...arguments);
        this.baseUrl = KOMIKAV_DOMAIN;
